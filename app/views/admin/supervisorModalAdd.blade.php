  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h3 class="modal-title"><i class="fa fa-user fa-fw"></i> Establecer rol de usuario en el recurso:<b> <span id ="ModalUsuerNombreRecurso"></span></b> <i>(<span id ="ModalUserNombreGrupo"></span>)</i></span> </h3>
      </div><!-- ./modal-header -->
              ...
              <div class="form-group" id="funcion">
                ...
                <div class = "col-md-10">  
                    <select class="form-control"  name="rol" id="selectrol">
                        <option value="1" selected="selected" >Técnico</option>
