...
<div class="modal fade" id="modaldisabledRecurso" tabindex="-2" role="dialog" aria-labelledby="disabledRecurso" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deshabilitarecurso" action="deshabilitarRecurso.html" method="post">         
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-danger" role = "alert">
                    ¿Estás seguro que deseas <b>deshabilitar</b> el recurso: "<b><span id="nombrerecursoDeshabilitar"></span>"</b> ?
                </div>
                <!-- mensaje -->  
                ...
                <input type="hidden" name="idDisableRecurso" value=""   />
