                ...
                @foreach($grupo->recursos as $recurso)
                    ...
                    <li ><span class="@if($recurso->disabled) text-warning @else text-success @endif">{{$recurso->nombre}}</span> 
                        ...
                        <div class="personas" style="display:none">
                            <a class="addUserWithRol text-danger"  href="" data-idrecurso="{{$recurso->id}}" data-nombrerecurso="{{$recurso->nombre}}" data-nombregrupo="{{$recurso->grupo->nombre}}" title="Añade usuarios con las relaciones de supervisor, tecnico y/o validador" ><i class="fa fa-user-plus fa-fw"></i></a>
                            <a class="removeUserWithRol text-danger"  href="" data-idrecurso="{{$recurso->id}}" data-nombrerecurso="{{$recurso->nombre}}" title="Elimina usuarios con  relación de supervisor, tecnico y/o validador" ><i class="fa fa-user-times fa-fw"></i></a>
