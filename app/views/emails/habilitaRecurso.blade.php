...
<h4>Se ha habilitado para su uso el recurso {{$e->recurso->nombre}} </h4>

<p> La reserva que acontinuación se detalla <b>se pueda realizar</b>. Puede contactar con la Unidad correspondiente (Administrador de Centro, Servicio MAV, o Unidad TIC) para más información.</p>
...
<h4><strong>Datos del evento:</strong></h4>
	...
	<ul style ="list-style:none;padding:5px">
		...
		<li class = 'subtitle'><strong>Solicitada por:</strong> <span>{{$e->user->nombre}} {{$e->user->apellidos}} </span></li>
